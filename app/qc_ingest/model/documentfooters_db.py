...
class DocumentfootersDb(SchemaBase):
   __tablename__ = "documentfooters_db"
...
# Index('documentfooters_db_doc_id',DocumentfootersDb.doc_id)
# Index('documentfooters_db_doc_id_hierarchy',DocumentfootersDb.doc_id,DocumentfootersDb.hierarchy)
# Index('documentfooters_db_iqv_standard_term',DocumentfootersDb.iqv_standard_term)
# Index('documentfooters_db_link_id',DocumentfootersDb.link_id)
# Index('documentfooters_db_link_id_level2',DocumentfootersDb.link_id_level2)
# Index('documentfooters_db_link_id_level3',DocumentfootersDb.link_id_level3)
# Index('documentfooters_db_link_id_level4',DocumentfootersDb.link_id_level4)
# Index('documentfooters_db_link_id_level5',DocumentfootersDb.link_id_level5)
# Index('documentfooters_db_link_id_level6',DocumentfootersDb.link_id_level6)
# Index('documentfooters_db_link_id_subsection1',DocumentfootersDb.link_id_subsection1)
# Index('documentfooters_db_link_id_subsection2',DocumentfootersDb.link_id_subsection2)
# Index('documentfooters_db_link_id_subsection3',DocumentfootersDb.link_id_subsection3)
# Index('documentfooters_db_parent_id',DocumentfootersDb.parent_id,DocumentfootersDb.group_type)
# Index('documentfooters_db_parent_id_hierarchy',DocumentfootersDb.parent_id,DocumentfootersDb.hierarchy,DocumentfootersDb.group_type)
