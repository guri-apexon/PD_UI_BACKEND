...
# Index('documenttables_db_doc_id',DocumenttablesDb.doc_id)
# Index('documenttables_db_doc_id_hierarchy',DocumenttablesDb.doc_id,DocumenttablesDb.hierarchy)
# Index('documenttables_db_iqv_standard_term',DocumenttablesDb.iqv_standard_term)
# Index('documenttables_db_link_id',DocumenttablesDb.link_id)
# Index('documenttables_db_link_id_level2',DocumenttablesDb.link_id_level2)
# Index('documenttables_db_link_id_level3',DocumenttablesDb.link_id_level3)
# Index('documenttables_db_link_id_level4',DocumenttablesDb.link_id_level4)
# Index('documenttables_db_link_id_level5',DocumenttablesDb.link_id_level5)
# Index('documenttables_db_link_id_level6',DocumenttablesDb.link_id_level6)
# Index('documenttables_db_link_id_subsection1',DocumenttablesDb.link_id_subsection1)
# Index('documenttables_db_link_id_subsection2',DocumenttablesDb.link_id_subsection2)
# Index('documenttables_db_link_id_subsection3',DocumenttablesDb.link_id_subsection3)
# Index('documenttables_db_parent_id',DocumenttablesDb.parent_id,DocumenttablesDb.group_type)
# Index('documenttables_db_parent_id_hierarchy',DocumenttablesDb.parent_id,DocumenttablesDb.hierarchy,DocumenttablesDb.group_type)
