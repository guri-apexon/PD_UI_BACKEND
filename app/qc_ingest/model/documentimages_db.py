...
class DocumentimagesDb(SchemaBase):
   __tablename__ = "documentimages_db"
...
# Index('documentimages_db_doc_id',DocumentimagesDb.doc_id)
# Index('documentimages_db_doc_id_hierarchy',DocumentimagesDb.doc_id,DocumentimagesDb.hierarchy)
# Index('documentimages_db_iqv_standard_term',DocumentimagesDb.iqv_standard_term)
# Index('documentimages_db_link_id',DocumentimagesDb.link_id)
# Index('documentimages_db_link_id_level2',DocumentimagesDb.link_id_level2)
# Index('documentimages_db_link_id_level3',DocumentimagesDb.link_id_level3)
# Index('documentimages_db_link_id_level4',DocumentimagesDb.link_id_level4)
# Index('documentimages_db_link_id_level5',DocumentimagesDb.link_id_level5)
# Index('documentimages_db_link_id_level6',DocumentimagesDb.link_id_level6)
# Index('documentimages_db_link_id_subsection1',DocumentimagesDb.link_id_subsection1)
# Index('documentimages_db_link_id_subsection2',DocumentimagesDb.link_id_subsection2)
# Index('documentimages_db_link_id_subsection3',DocumentimagesDb.link_id_subsection3)
# Index('documentimages_db_parent_id',DocumentimagesDb.parent_id,DocumentimagesDb.group_type)
# Index('documentimages_db_parent_id_hierarchy',DocumentimagesDb.parent_id,DocumentimagesDb.hierarchy,DocumentimagesDb.group_type)
