...
class DocumentheadersDb(SchemaBase):
   __tablename__ = "documentheaders_db"
...
# Index('documentheaders_db_doc_id',DocumentheadersDb.doc_id)
# Index('documentheaders_db_doc_id_hierarchy',DocumentheadersDb.doc_id,DocumentheadersDb.hierarchy)
# Index('documentheaders_db_iqv_standard_term',DocumentheadersDb.iqv_standard_term)
# Index('documentheaders_db_link_id',DocumentheadersDb.link_id)
# Index('documentheaders_db_link_id_level2',DocumentheadersDb.link_id_level2)
# Index('documentheaders_db_link_id_level3',DocumentheadersDb.link_id_level3)
# Index('documentheaders_db_link_id_level4',DocumentheadersDb.link_id_level4)
# Index('documentheaders_db_link_id_level5',DocumentheadersDb.link_id_level5)
# Index('documentheaders_db_link_id_level6',DocumentheadersDb.link_id_level6)
# Index('documentheaders_db_link_id_subsection1',DocumentheadersDb.link_id_subsection1)
# Index('documentheaders_db_link_id_subsection2',DocumentheadersDb.link_id_subsection2)
# Index('documentheaders_db_link_id_subsection3',DocumentheadersDb.link_id_subsection3)
# Index('documentheaders_db_parent_id',DocumentheadersDb.parent_id,DocumentheadersDb.group_type)
# Index('documentheaders_db_parent_id_hierarchy',DocumentheadersDb.parent_id,DocumentheadersDb.hierarchy,DocumentheadersDb.group_type)
