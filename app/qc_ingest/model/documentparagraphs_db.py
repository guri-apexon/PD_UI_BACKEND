...
# Index('documentparagraphs_db_doc_id',DocumentparagraphsDb.doc_id)
# Index('documentparagraphs_db_doc_id_hierarchy',DocumentparagraphsDb.doc_id,DocumentparagraphsDb.hierarchy)
# Index('documentparagraphs_db_iqv_standard_term',DocumentparagraphsDb.iqv_standard_term)
# Index('documentparagraphs_db_link_id',DocumentparagraphsDb.link_id)
# Index('documentparagraphs_db_link_id_level2',DocumentparagraphsDb.link_id_level2)
# Index('documentparagraphs_db_link_id_level3',DocumentparagraphsDb.link_id_level3)
# Index('documentparagraphs_db_link_id_level4',DocumentparagraphsDb.link_id_level4)
# Index('documentparagraphs_db_link_id_level5',DocumentparagraphsDb.link_id_level5)
# Index('documentparagraphs_db_link_id_level6',DocumentparagraphsDb.link_id_level6)
# Index('documentparagraphs_db_link_id_subsection1',DocumentparagraphsDb.link_id_subsection1)
# Index('documentparagraphs_db_link_id_subsection2',DocumentparagraphsDb.link_id_subsection2)
# Index('documentparagraphs_db_link_id_subsection3',DocumentparagraphsDb.link_id_subsection3)
# Index('documentparagraphs_db_parent_id',DocumentparagraphsDb.parent_id,DocumentparagraphsDb.group_type)
# Index('documentparagraphs_db_parent_id_hierarchy',DocumentparagraphsDb.parent_id,DocumentparagraphsDb.hierarchy,DocumentparagraphsDb.group_type)
