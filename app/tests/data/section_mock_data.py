...
configuration_api_data = [
    ...
    ("00d9456f-b5d3-4045-b76f-3bdecbe99775","","","1150903","005", "clinical_terms,time_points,preferred_terms,redaction_attributes,references,properties", "" ,404,"No section text provided"),
    ...
    ("00d9456f-b5d3-4045-b76f-3bdecbe99775", "1", "", "1034911",
     "SSRUT_GEN_001","clinical_terms,preferred_terms,redaction_attributes,references,properties","3.1. Study Rationale", 200, "NO_TIME_POINT_DATA"),
    ("00d9456f-b5d3-4045-b76f-3bdecbe99775", "1", "", "1034911",
     "SSRUT_GEN_001","clinical_terms,preferred_terms,redaction_attributes,time_points,properties","3.1. Study Rationale", 200, "NO_REFERENCE_DATA"),
