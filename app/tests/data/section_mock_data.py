...
configuration_api_data = [
    ...
    ("5c784c05-fbd3-4786-b0e4-3afa0d1c61ac", "1", "", "1034911",
     "SSRUT_GEN_001","","", 404, "doc id and without link id so no section data returned"),
    ...
    ("21cb6042-fe5f-4230-94f2-5593fb33f522","","","1150903","005", "clinical_terms,time_points,preferred_terms,redaction_attributes,references,properties", "" ,404,"No section text provided"),
    ("ec06c44f-3f09-46f7-9fa8-547916ca89d9","","","1150903","005",
    ...
    ("ec06c44f-3f09-46f7-9fa8-547916ca89d9", "1", "", "1034911",
     "SSRUT_GEN_001","clinical_terms,preferred_terms,redaction_attributes,references,properties","10. TREATMENT OF Subjects", 200, "NO_TIME_POINT_DATA"),
    ("ec06c44f-3f09-46f7-9fa8-547916ca89d9", "1", "", "1034911",
     "SSRUT_GEN_001","clinical_terms,preferred_terms,redaction_attributes,time_points,properties","10. TREATMENT OF Subjects", 200, "NO_REFERENCE_DATA"),
