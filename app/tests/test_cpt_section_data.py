...
@pytest.mark.parametrize("doc_id, link_level, link_id, user_id, protocol, user_type, status_code, comments", [
    ("5c784c05-fbd3-4786-b0e4-3afa0d1c61ac", "1", "", "1034911", "SSRUT_GEN_001",
     "normal", 200, "doc older than legacy_upload_date for secondary users"),
    ("1698be28-1cf3-466e-8f56-5fc920029057", "1", "", "1036048",
     "FEED_TEST4", "normal", 200, "doc newer than legacy_upload_date"),
    ("1698be28-1cf3-466e-8f56-5fc920029056", "1", "", "1036048",
     "FEED_TEST4", "normal", 206, "doc newer than legacy_upload_date"),
    ("21552918-f506-43d8-8879-4fe532631ba7", "", "8f8e70a7-cb76-4257-b595-80a2564a8aa2", "Dig2_Batch_Tester",
     "BI.Obesity.91af1307-5fc5-40cd-9671-b82771a42b2f", "normal", 200, "doc newer than legacy_upload_date")
])
def test_document_object(new_token_on_headers, user_id, protocol, doc_id, user_type, status_code, comments, link_level, link_id):
    """
